...
public class AddData extends javax.swing.JFrame {
    ...
    private int fillJobList()
    {
        ...
        {
            int arriveTime = userData[i];
            int burstTime = userData[(i)+1];
            int priority = userData[(i)+2];
            /*if(checkJob(arriveTime,burstTime,priority ))
            {*/
               list.add(new Job(K, arriveTime, burstTime, priority));
               K++;
            //}
        }
        return 0;
    ...
    {
        if( arrive < 0  || arrive > 120 ) {return false;}
        if( burst <= 0 || burst > 127 ) {return false;}
        if( priority <=0  || priority > 15) {return false;}
        return true;
    }
